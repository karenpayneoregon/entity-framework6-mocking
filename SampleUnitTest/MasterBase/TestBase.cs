...
namespace SampleUnitTest
{
    ...
    public class TestBase
    {
        ...
        /// in the empty try/catch statements to figure out the issue. More likely
        ...
        public bool AnnihilateData(List<object> mAnnihilateList)
        {
            ...
            using (var destroyContext = new PersonEntities())
            {
                ...
                for (int index = mAnnihilateList.Count - 1; index >= 0; index--)
                {
                    try
                    {
                        var currentObject = mAnnihilateList[index];
                ...
                try
                {
                    ...
                    var annihilationCount = mAnnihilateList.Count;

                    mAnnihilateDataSuccessful = (resultCount == annihilationCount);
